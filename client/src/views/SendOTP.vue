        ...
        <div class="col-md-6 box">
            <div class="d-flex justify-content-center flex-column align-items-center">
              ...
              <div class="d-flex justify-content-center gap-2 mb-3">
                ...
                <!-- Resend OTP Button -->
                <p
                    class="text-center font-roboto font-semibold text-l mt-[17px] text-[#608BC1] hover:text-[#1e61d6] cursor-pointer"
                    @click="resendOTP"
                    v-if="cooldown === 0"
                >
                    Resend the OTP
                ...
                <p
                    class="text-center font-roboto font-semibold text-l mt-[17px] text-[#608BC1] cursor-not-allowed"
                    v-else
                >
