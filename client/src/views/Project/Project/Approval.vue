      ...
      <div class="p-2">
        <nav class="px-5 pb-4 pt-5 rounded-top-4" style="background-color: #EFEDEF; padding-top: 2.5rem;">
          ...
          <div class="d-flex flex-column">
            <h3 class="fw-bold fs-3 me-auto mb-md-2">Approval Project</h3>
          </div>
          <Navbar />
        </nav>
            ...
            <div class="text-start py-4">
              <div class="d-flex align-center">
                <input 
                  ...
                  id="approvalCheck" 
                />
                <label for="approvalCheck" class="ms-2 text-wrap">I have completed and i'm ready to approve it.</label>
              </div>
              <br>
