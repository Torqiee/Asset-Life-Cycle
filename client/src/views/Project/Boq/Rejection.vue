          ...
          <div class="row g-3 mx-3 px-4 pb-4 rounded-4" style="background-color: #EAE8EA;">
            ...
            <div class="table-responsive px-2">
              ...
              <div class="text-start py-4">
                <input 
                  type="checkbox" 
                  v-model="confirmRejection" 
                  id="approvalCheck" 
                />
                <label for="approvalCheck" class="ms-2">I have completed my review of the BoQ data and am ready to reject it.</label>
                <br>
                <div class="text-center mt-5">
                    <button class="btn btn-md text-white fw-medium px-5" :disabled="!confirmRejection" @click="rejectBoq" style="background-color: #133E87;">
                      Reject
                    </button>
                </div>
              </div>
